#
# Chippery project configuration for UWA Courses
####################################################
...
# Return YAML config for the UWA Courses project.
{% macro uwa_courses() %}
  {% set deploy_name = kwargs.get('name', 'uwa-courses') %}
  {% set fqdn = kwargs.get('fqdn', 'courseinfo.uwa.edu.au') %}
  ...
  {{- deploy_name ~ ':' }}
    ...
    # Project source
    git_url: git@github.com:hipikat/uwa_courses.git
